...
void saveFrameBuff1(GLsizei width, GLsizei height, unsigned int framebuffer)
{
    ...
    GLubyte* image_src = (GLubyte*)malloc(width * height * 4 * sizeof(GLubyte));//[100 * 100 * 4];
    printf("%d \n", sizeof(GLubyte));
    //GLubyte image_src[width * height * 4];
    glReadPixels(0, 0, width, height, GL_RGBA, GL_UNSIGNED_BYTE, image_src);

    stbi_write_tga("out.tga", width, height, 4, image_src);
}
...
int main()
{
    ...
    // load models
    // -----------
    Model ourModel("E:/ToolsProj/USDTest/Assets/TestRes/CombineOut.fbx");
    ...
    //while (!glfwWindowShouldClose(window))
    {
        ...
        saveFrameBuff1(SCR_WIDTH, SCR_HEIGHT, intermediateFBO);
